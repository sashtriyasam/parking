            ...
            <header className="bg-white border-b border-gray-100 sticky top-0 z-40">
                <div className="max-w-7xl mx-auto px-6 py-8 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-black text-gray-900 tracking-tight leading-none mb-2">Activities</h1>
                            <p className="text-xs font-black text-gray-400 uppercase tracking-widest">Track your parking sessions</p>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-64 h-14 pl-12 pr-6 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-bold focus:bg-white focus:border-indigo-600 outline-none transition-all shadow-sm"
                            />
                        </div>
                        <button className="p-4 bg-gray-100 text-gray-500 rounded-2xl hover:bg-indigo-50 hover:text-indigo-600 transition-all">
                            <Filter size={24} />
                        </button>
                    </div>
                </div>
